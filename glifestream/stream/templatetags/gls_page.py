...
MESSAGES = (
    gettext_noop('Align center'),
    gettext_noop('Align left'),
    gettext_noop('Align right'),
    gettext_noop('Are you sure?'),
    gettext_noop('Bold'),
    gettext_noop('Bullet list'),
    gettext_noop('Clear formatting'),
    gettext_noop('Click and Listen'),
    gettext_noop('Code block'),
    gettext_noop('Communication Error. Try again.'),
    gettext_noop('Entry hidden'),
    gettext_noop('Favorite'),
    gettext_noop('Fetch queued.'),
    gettext_noop('Formatting'),
    gettext_noop('Heading 1'),
    gettext_noop('Heading 2'),
    gettext_noop('Image'),
    gettext_noop('Italic'),
    gettext_noop('Justify'),
    gettext_noop('Keep the original author?'),
    gettext_noop('Link'),
    gettext_noop('Link address:'),
    gettext_noop('Never'),
    gettext_noop('Next year'),
    gettext_noop('No completed runs'),
    gettext_noop('Not scheduled'),
    gettext_noop('Numbered list'),
